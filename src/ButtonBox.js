...
const ButtonBox = (props) =>
{
  ...
  <div className="button-box">
    ...
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="4" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="5" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="6" />
    <Button onClick={props.operatorHandler} buttonType="number-btn" buttonDetail="operator" value="×" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="1" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="2" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="3" />
    <Button onClick={props.operatorHandler} buttonType="number-btn" buttonDetail="operator" value="-" />
    <Button onClick={props.equalHandler} buttonType="number-btn" buttonDetail="equal" value="=" />
    <Button onClick={props.numberHandler} buttonType="number-btn" buttonDetail="number" value="0" />
